...
//Code Here
//creates new array to keep a record of the old
// in nesting.js we use foreach to update existing array
const recordCleaner = arr => {
  myCar.accidents = myCar.accidents.map(record => {
    return { ...record, atFaultForAccident: false }
  })
}
